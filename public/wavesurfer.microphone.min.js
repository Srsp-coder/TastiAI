            ...
            function e(t, r) {
              ...
              void 0 === navigator.mediaDevices &&
                ...
                void 0 === navigator.mediaDevices.getUserMedia &&
                  (navigator.mediaDevices.getUserMedia = function (e, t, r) {
                    var i =
                ...
                (this._onBackendCreated = function () {
                  i.micContext = i.wavesurfer.backend.getAudioContext();
                });
            }
            var t, r, n;
            return (
              ...
              (r = [
                {
                  ...
                  value: function () {
                    this.wavesurfer.on(
                      ...
                      this.wavesurfer.backend && this._onBackendCreated();
                  },
                },
                {
                  key: "destroy",
                  ...
                  value: function () {
                    void 0 !== this.stream &&
                      ...
                      (this.mediaStreamSource =
                        this.micContext.createMediaStreamSource(this.stream)),
                      (this.levelChecker =
                  ...
                  value: function () {
                    void 0 !== this.mediaStreamSource &&
                      ...
                      void 0 !== this.levelChecker &&
                        ...
                        (this.levelChecker.onaudioprocess = void 0)),
                      void 0 !== this.localAudioBuffer &&
                        (this.localAudioBuffer = void 0);
                  },
                },
                {
                  key: "reloadBuffer",
                      ...
                      if (
                        ...
                        for (
                          ...
                          this.localAudioBuffer
                            .getChannelData(t)
                            .set(e.inputBuffer.getChannelData(t));
                ...
                },
                {
                  key: "detectBrowser",
                  value: function () {
                    var e = { browser: null, version: null, minVersion: null };
                    return "undefined" != typeof window && window.navigator
                      ? navigator.mozGetUserMedia
                        ...
                        ? ((e.browser = "safari"),
                          ...
                          e)
                        : ((e.browser = "Not a supported browser."), e)
                      : ((e.browser = "Not a supported browser."), e);
                  },
                },
              ]) && i(t.prototype, r),
